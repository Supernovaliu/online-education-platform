...
<head>
    ...
    <![endif]-->
    <title>adminlogin - Backend log in page</title>
    <meta name="keywords" content="Backend login in page,H-ui template">
    <meta name="description" content="Backend login in page">
</head>
<body>
...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="/admin/public/check" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <input name="" type="submit" class="btn btn-success radius size-L" value="&nbsp;Log&nbsp;&nbsp;&nbsp;&nbsp;In&nbsp;">
                    <input name="" type="reset" class="btn btn-default radius size-L" value="&nbsp;Give&nbsp;&nbsp;&nbsp;&nbsp;Up&nbsp;">
                </div>
            </div>
        </form>
    </div>
</div>
<div class="footer">Copyright your company name by H-ui.admin v3.1</div>
     ...
     $(function(){
       ...
       @if (count($errors) > 0)
           ...
           @foreach ($errors ->all() as $error)
                allError += "{{$error}}<br/>";
           @endforeach
              layer.alert(allError,{title:'Error Alert',icon: 5});
       @endif
